...
def normal_ordered(operator, hbar=1.0):
    ...
    * FermionOperators: a^\dagger comes before a
    ...
    Args:
        operator: an instance of the FermionOperator, or InteractionOperator classes.
    ...
    if isinstance(operator, FermionOperator):
        ...
        raise TypeError(
            "Can only normal order FermionOperator, " "or InteractionOperator."
        )
...
def normal_ordered_ladder_term(term, coefficient, parity=-1):
    ...
    Returns:
        ordered_term: a FermionOperator instance.
