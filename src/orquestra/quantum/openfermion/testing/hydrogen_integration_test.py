...
class HydrogenIntegrationTest(unittest.TestCase):
    ...
    def test_qubit_operator(self):
        ...
        self.assertAlmostEqual(
            self.qubit_hamiltonian.terms[((0, "Z"), (1, "Z"))], f3, places=4
        )

        self.assertAlmostEqual(
            self.qubit_hamiltonian.terms[((0, "Z"), (2, "Z"))], f4, places=4
        )
        self.assertAlmostEqual(
            self.qubit_hamiltonian.terms[((1, "Z"), (3, "Z"))], f4, places=4
        )

        self.assertAlmostEqual(
            self.qubit_hamiltonian.terms[((1, "Z"), (2, "Z"))], f5, places=4
        )
        self.assertAlmostEqual(
            self.qubit_hamiltonian.terms[((0, "Z"), (3, "Z"))], f5, places=4
        )

        self.assertAlmostEqual(
            self.qubit_hamiltonian.terms[((2, "Z"), (3, "Z"))], f6, places=4
        )

        self.assertAlmostEqual(
            self.qubit_hamiltonian.terms[((0, "Y"), (1, "Y"), (2, "X"), (3, "X"))],
            -f7,
            places=4,
        )
        self.assertAlmostEqual(
            self.qubit_hamiltonian.terms[((0, "X"), (1, "X"), (2, "Y"), (3, "Y"))],
            -f7,
            places=4,
        )

        self.assertAlmostEqual(
            self.qubit_hamiltonian.terms[((0, "X"), (1, "Y"), (2, "Y"), (3, "X"))],
            f7,
            places=4,
        )
        self.assertAlmostEqual(
            self.qubit_hamiltonian.terms[((0, "Y"), (1, "X"), (2, "X"), (3, "Y"))],
            f7,
            places=4,
        )
