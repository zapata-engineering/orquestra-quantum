...
class UnitaryCC(unittest.TestCase):
    ...
    def test_uccsd_singlet_anti_hermitian(self):
        ...
        generator = uccsd_singlet_generator(
            packed_amplitudes, test_orbitals, test_electrons
        )
    ...
    def test_uccsd_singlet_get_packed_amplitudes(self):
        ...
        self.assertTrue(
            numpy.allclose(
                packed_amplitudes, numpy.array([0.12345, 0.0, 0.9, 0.0, 0.3434])
            )
        )
    ...
    def test_ucc_h2(self):
        ...
        self.assertAlmostEqual(
            expected_uccsd_energy, self.molecule.fci_energy, places=4
        )
