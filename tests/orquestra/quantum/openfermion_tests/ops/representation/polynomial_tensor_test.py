...
class PolynomialTensorTest(unittest.TestCase):
    ...
    def test_setitem_2body(self):
        ...
        self.assertEqual(
            self.polynomial_tensor_a.n_body_tensors[(1, 1, 0, 0)][0, 1, 1, 0], 3
        )
        self.assertEqual(
            self.polynomial_tensor_a.n_body_tensors[(1, 1, 0, 0)][1, 0, 0, 1], 2
        )
    ...
    def test_mul(self):
        ...
        self.assertEqual(
            ...
            get_fermion_operator(self.polynomial_tensor_a) * 2.0,
        )
        self.assertEqual(
    ...
    def test_div(self):
        ...
        self.assertEqual(
            get_fermion_operator(new_tensor),
            get_fermion_operator(self.polynomial_tensor_a) / 2.0,
        )
    ...
    def test_idiv(self):
        ...
        self.assertEqual(
            get_fermion_operator(new_tensor),
            get_fermion_operator(self.polynomial_tensor_a) / 3.0,
        )
